    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(null=True, upload_to=games.models.logo_directory_path, verbose_name='Logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.DateField(default=datetime.date.today, null=True, verbose_name='Release game')),
                ('url', models.SlugField(max_length=130, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Draft')),
                ('developer', models.ManyToManyField(null=True, related_name='game_developer', to='games.developer', verbose_name='developer')),
                ('game_platform', models.ManyToManyField(null=True, to='games.gameplatform')),
                ('genres', models.ManyToManyField(to='games.genres', verbose_name='genres')),
                ('publisher', models.ManyToManyField(null=True, related_name='game_publisher', to='games.publisher', verbose_name='publisher')),
            ],
        ),
        migrations.CreateModel(
            name='GamesImages',
